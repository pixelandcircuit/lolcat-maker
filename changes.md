...
- `public/icon-b.svg` — source SVG (512×512)
- `public/icon-512.png`, `icon-192.png`, `apple-touch-icon.png` (180×180), `favicon-32.png` — PNG exports generated by `scripts/generate-icons.mjs` using `sharp`
- `public/manifest.webmanifest` — PWA web manifest (name, theme color, icon references)
- `index.html` — added `<link rel="icon">` (SVG + 32px PNG fallback), `<link rel="apple-touch-icon">`, `<link rel="manifest">`, and `<meta name="theme-color">`; also corrected page title to "Meem Makr"
- `sharp` added as a devDependency for the icon generation script
